  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200 mb-8">
      <div className="flex items-center mb-6">
        <Skeleton className="w-5 h-6 rounded-md mr-2" />
        <Skeleton className="h-6 w-1/8" />
      </div>

      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
        <div className="flex items-start">
          <Skeleton className="w-5 h-5 rounded-md mr-3 mt-1 shrink-0" />
          <div>
            <Skeleton className="h-3 w-20" />
            <Skeleton className="h-5 w-28 mt-1.5" />
          </div>
        </div>
        <div className="flex items-start">
          <Skeleton className="w-5 h-5 rounded-md mr-3 mt-1 shrink-0" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gray-100 border border-gray-200 p-4 rounded-lg flex items-start">
          <Skeleton className="w-5 h-5 rounded-md bg-gray-300 mr-3 mt-1 shrink-0" />
          <div>
            <Skeleton className="h-4 w-20 bg-gray-300" />
            <Skeleton className="h-7 w-12 bg-gray-300 mt-1.5" />
          </div>
        </div>
        <div className="bg-gray-100 border border-gray-200 p-4 rounded-lg flex items-start">
          <Skeleton className="w-5 h-5 rounded-md bg-gray-300 mr-3 mt-1 shrink-0" />
          <div>
            ...
            <Skeleton className="h-7 w-16 bg-gray-300 mt-1.5" />
          </div>
        </div>
        <div className="bg-gray-100 border border-gray-200 p-4 rounded-lg flex items-start">
          <Skeleton className="w-5 h-5 rounded-md bg-gray-300 mr-3 mt-1 shrink-0" />
          <div>
            ...
            <Skeleton className="h-7 w-20 bg-gray-300 mt-1.5" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="bg-gray-100 border border-gray-200 p-4 rounded-lg md:flex items-center justify-between gap-5 h-max">
          <div className="p-3 w-full md:w-auto">
            <div className="flex-col lg:w-full">
              <Skeleton className="h-5 bg-gray-300 w-1/2" />
              <Skeleton className="h-3 bg-gray-300 w-full mt-2" />
              <Skeleton className="h-3 bg-gray-300 w-3/4 mt-1" />
            </div>

            <div className="flex flex-wrap gap-3 mt-3">
              <div className="flex lg:w-max items-center">
                <Skeleton className="w-6 h-6 bg-gray-300 rounded-full mr-2" />
                <Skeleton className="h-4 bg-gray-300 w-32" />
              </div>
              <div className="flex lg:w-max items-center">
                <Skeleton className="w-5 h-6 bg-gray-300 rounded-full mr-2" />
